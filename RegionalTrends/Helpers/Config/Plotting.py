...
VAR_COLORS_CFG = {
    ...
    'P_rel': {'cmap_mean': cmocean.cm.rain, 'extreme_mean': (None, '#040812'), 
          'cmap_trend': plt.get_cmap('BrBG', 20), 'extreme_trend': ('#271500', '#001f1f')},
    ...
    'LWin': {'cmap_mean': cmocean.cm.balance, 'extreme_mean': ('#000020', '#350000')},
    'LWincs': {'cmap_mean': cmocean.cm.balance, 'extreme_mean': ('#000020', '#350000')},
    'LWnet': {'cmap_mean': cmocean.cm.balance, 'extreme_mean': ('#000020', '#350000')},
    'LWnetcs': {'cmap_mean': cmocean.cm.balance, 'extreme_mean': ('#000020', '#350000')},
    'SHF': {'cmap_mean': cmocean.cm.balance, 'extreme_mean': ('#000020', '#350000')},
    'LHF': {'cmap_mean': cmocean.cm.balance, 'extreme_mean': ('#000020', '#350000')},
