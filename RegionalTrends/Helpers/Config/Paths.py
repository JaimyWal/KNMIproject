...
BASE_DIR_CFG = {
    ...
    'RACMO2.4A_rerun_3H': '/nobackup/users/walj/racmo24A_rerun/Threehourly',
    'RACMO2.4A_rerun': '/nobackup_1/users/walj/racmo24A_rerun',
...
def build_file_cfg(freq_str):
    ...
    cfg['RACMO2.4AR'] = {
        'Tg': connect_paths('RACMO2.4A_rerun', f'{freq_str}/tas{racmo24_sep}*.nc'),
        'Tmax': connect_paths('RACMO2.4A_rerun', f'{freq_str}/tasmax{racmo24_sep}*.nc'),
        'Tmin': connect_paths('RACMO2.4A_rerun', f'{freq_str}/tasmin{racmo24_sep}*.nc'),
        'P': connect_paths('RACMO2.4A_rerun', f'{freq_str}/pr{racmo24_sep}*.nc'),
        'Ps': connect_paths('RACMO2.4A_rerun', f'{freq_str}/ps{racmo24_sep}*.nc'),
        'Psl': connect_paths('RACMO2.4A_rerun', f'{freq_str}/psl{racmo24_sep}*.nc'),
        'RH': connect_paths('RACMO2.4A_rerun', f'{freq_str}/hurs{racmo24_sep}*.nc'),
        'Tdew': connect_paths('RACMO2.4A_rerun', f'{freq_str}/tdew2m{racmo24_sep}*.nc'),
        'Sq': connect_paths('RACMO2.4A_rerun', f'{freq_str}/sund{racmo24_sep}*.nc'),
        'SWin': connect_paths('RACMO2.4A_rerun', f'{freq_str}/rsds{racmo24_sep}*.nc'),
        'SWnet': connect_paths('RACMO2.4A_rerun', f'{freq_str}/ssr{racmo24_sep}*.nc'),
        'SWincs': connect_paths('RACMO2.4A_rerun', f'{freq_str}/rsdscs{racmo24_sep}*.nc'),
        'SWnetcs': connect_paths('RACMO2.4A_rerun', f'{freq_str}/ssrc{racmo24_sep}*.nc'),
        'LWin': connect_paths('RACMO2.4A_rerun', f'{freq_str}/rlds{racmo24_sep}*.nc'),
        'LWnet': connect_paths('RACMO2.4A_rerun', f'{freq_str}/str{racmo24_sep}*.nc'),
        'LWincs': connect_paths('RACMO2.4A_rerun', f'{freq_str}/rldscs{racmo24_sep}*.nc'),
        'LWnetcs': connect_paths('RACMO2.4A_rerun', f'{freq_str}/strc{racmo24_sep}*.nc'),
        'SHF': connect_paths('RACMO2.4A_rerun', f'{freq_str}/hfss{racmo24_sep}*.nc'),
        'LHF': connect_paths('RACMO2.4A_rerun', f'{freq_str}/hfls{racmo24_sep}*.nc'),
        'CloudLow': connect_paths('RACMO2.4A_rerun', f'{freq_str}/cll{racmo24_sep}*.nc'),
        'CloudMid': connect_paths('RACMO2.4A_rerun', f'{freq_str}/clm{racmo24_sep}*.nc'),
        'CloudHigh': connect_paths('RACMO2.4A_rerun', f'{freq_str}/clh{racmo24_sep}*.nc'),
        'CloudTotal': connect_paths('RACMO2.4A_rerun', f'{freq_str}/clt{racmo24_sep}*.nc'),
        'LWP': connect_paths('RACMO2.4A_rerun', f'{freq_str}/clwvi{racmo24_sep}*.nc'),
        'IWP': connect_paths('RACMO2.4A_rerun', f'{freq_str}/clivi{racmo24_sep}*.nc'),
        'Q': connect_paths('RACMO2.4A_rerun', f'{freq_str}/huss{racmo24_sep}*.nc'),
        'Ts': connect_paths('RACMO2.4A_rerun', f'{freq_str}/ts{racmo24_sep}*.nc'),
        'SWC': connect_paths('RACMO2.4A_rerun', f'{freq_str}/wskin{racmo24_sep}*.nc'),
        'SWVL1': connect_paths('RACMO2.4A_rerun', f'{freq_str}/swvl1{racmo24_sep}*.nc'),
        'SWVL2': connect_paths('RACMO2.4A_rerun', f'{freq_str}/swvl2{racmo24_sep}*.nc'),
        'SWVL3': connect_paths('RACMO2.4A_rerun', f'{freq_str}/swvl3{racmo24_sep}*.nc'),
        'SWVL4': connect_paths('RACMO2.4A_rerun', f'{freq_str}/swvl4{racmo24_sep}*.nc'),
        'TWC': connect_paths('RACMO2.4A_rerun', f'{freq_str}/tcw{racmo24_sep}*.nc'),
        'TWV': connect_paths('RACMO2.4A_rerun', f'{freq_str}/prw{racmo24_sep}*.nc'),
        'TSWin': connect_paths('RACMO2.4A_rerun', f'{freq_str}/rsdt{racmo24_sep}*.nc'),
        'TSWnet': connect_paths('RACMO2.4A_rerun', f'{freq_str}/tsr{racmo24_sep}*.nc'),
        'TLWnet': connect_paths('RACMO2.4A_rerun', f'{freq_str}/toptr{racmo24_sep}*.nc'),
        'TSWnetcs': connect_paths('RACMO2.4A_rerun', f'{freq_str}/src{racmo24_sep}*.nc'),
        'TLWnetcs': connect_paths('RACMO2.4A_rerun', f'{freq_str}/trc{racmo24_sep}*.nc'),
        'U10': connect_paths('RACMO2.4A_rerun', f'{freq_str}/uas{racmo24_sep}*.nc'),
        'V10': connect_paths('RACMO2.4A_rerun', f'{freq_str}/vas{racmo24_sep}*.nc'),
        'uwind40': connect_paths('RACMO2.4A_rerun', f'{freq_str}/uwind40{racmo24_sep}*.nc'),
        'vwind40': connect_paths('RACMO2.4A_rerun', f'{freq_str}/vwind40{racmo24_sep}*.nc'),
        'uwind39': connect_paths('RACMO2.4A_rerun', f'{freq_str}/uwind39{racmo24_sep}*.nc'),
        'vwind39': connect_paths('RACMO2.4A_rerun', f'{freq_str}/vwind39{racmo24_sep}*.nc'),
        'temp40': connect_paths('RACMO2.4A_rerun', f'{freq_str}/temp40{racmo24_sep}*.nc'),
        'temp39': connect_paths('RACMO2.4A_rerun', f'{freq_str}/temp39{racmo24_sep}*.nc'),
        'sst': connect_paths('RACMO2.4A_rerun', f'{freq_str}/sst{racmo24_sep}*.nc'),

        'adicomp': connect_paths('RACMO2.4A_rerun', f'{freq_str}/adicomp{racmo24_enbudsep}*.nc'),
        'confric': connect_paths('RACMO2.4A_rerun', f'{freq_str}/confric{racmo24_enbudsep}*.nc'),
        'conphase': connect_paths('RACMO2.4A_rerun', f'{freq_str}/conphase{racmo24_enbudsep}*.nc'),
        'consens': connect_paths('RACMO2.4A_rerun', f'{freq_str}/consens{racmo24_enbudsep}*.nc'),
        'contot': connect_paths('RACMO2.4A_rerun', f'{freq_str}/contot{racmo24_enbudsep}*.nc'),
        'dyntot': connect_paths('RACMO2.4A_rerun', f'{freq_str}/dyntot{racmo24_enbudsep}*.nc'),
        'horadv': connect_paths('RACMO2.4A_rerun', f'{freq_str}/horadv{racmo24_enbudsep}*.nc'),
        'lcbotdn': connect_paths('RACMO2.4A_rerun', f'{freq_str}/lcbotdn{racmo24_enbudsep}*.nc'),
        'lcbotup': connect_paths('RACMO2.4A_rerun', f'{freq_str}/lcbotup{racmo24_enbudsep}*.nc'),
        'lcnet': connect_paths('RACMO2.4A_rerun', f'{freq_str}/lcnet{racmo24_enbudsep}*.nc'),
        'lctopdn': connect_paths('RACMO2.4A_rerun', f'{freq_str}/lctopdn{racmo24_enbudsep}*.nc'),
        'lctopup': connect_paths('RACMO2.4A_rerun', f'{freq_str}/lctopup{racmo24_enbudsep}*.nc'),
        'lscld': connect_paths('RACMO2.4A_rerun', f'{freq_str}/lscld{racmo24_enbudsep}*.nc'),
        'lwbotdn': connect_paths('RACMO2.4A_rerun', f'{freq_str}/lwbotdn{racmo24_enbudsep}*.nc'),
        'lwbotup': connect_paths('RACMO2.4A_rerun', f'{freq_str}/lwbotup{racmo24_enbudsep}*.nc'),
        'lwnet': connect_paths('RACMO2.4A_rerun', f'{freq_str}/lwnet{racmo24_enbudsep}*.nc'),
        'lwtopdn': connect_paths('RACMO2.4A_rerun', f'{freq_str}/lwtopdn{racmo24_enbudsep}*.nc'),
        'lwtopup': connect_paths('RACMO2.4A_rerun', f'{freq_str}/lwtopup{racmo24_enbudsep}*.nc'),
        'mlmid': connect_paths('RACMO2.4A_rerun', f'{freq_str}/mlmid{racmo24_enbudsep}*.nc'),
        'mltop': connect_paths('RACMO2.4A_rerun', f'{freq_str}/mltop{racmo24_enbudsep}*.nc'),
        'numbnd': connect_paths('RACMO2.4A_rerun', f'{freq_str}/numbnd{racmo24_enbudsep}*.nc'),
        'numdif': connect_paths('RACMO2.4A_rerun', f'{freq_str}/numdif{racmo24_enbudsep}*.nc'),
        'orography': connect_paths('RACMO2.4A_rerun', f'{freq_str}/orography{racmo24_enbudsep}*.nc'),
        'phystot': connect_paths('RACMO2.4A_rerun', f'{freq_str}/phystot{racmo24_enbudsep}*.nc'),
        'radtot': connect_paths('RACMO2.4A_rerun', f'{freq_str}/radtot{racmo24_enbudsep}*.nc'),
        'scbotdn': connect_paths('RACMO2.4A_rerun', f'{freq_str}/scbotdn{racmo24_enbudsep}*.nc'),
        'scbotup': connect_paths('RACMO2.4A_rerun', f'{freq_str}/scbotup{racmo24_enbudsep}*.nc'),
        'scnet': connect_paths('RACMO2.4A_rerun', f'{freq_str}/scnet{racmo24_enbudsep}*.nc'),
        'sctopdn': connect_paths('RACMO2.4A_rerun', f'{freq_str}/sctopdn{racmo24_enbudsep}*.nc'),
        'sctopup': connect_paths('RACMO2.4A_rerun', f'{freq_str}/sctopup{racmo24_enbudsep}*.nc'),
        'swbotdn': connect_paths('RACMO2.4A_rerun', f'{freq_str}/swbotdn{racmo24_enbudsep}*.nc'),
        'swbotup': connect_paths('RACMO2.4A_rerun', f'{freq_str}/swbotup{racmo24_enbudsep}*.nc'),
        'swnet': connect_paths('RACMO2.4A_rerun', f'{freq_str}/swnet{racmo24_enbudsep}*.nc'),
        'swtopdn': connect_paths('RACMO2.4A_rerun', f'{freq_str}/swtopdn{racmo24_enbudsep}*.nc'),
        'swtopup': connect_paths('RACMO2.4A_rerun', f'{freq_str}/swtopup{racmo24_enbudsep}*.nc'),
        'templ1': connect_paths('RACMO2.4A_rerun', f'{freq_str}/templ1{racmo24_enbudsep}*.nc'),
        'templ1s': connect_paths('RACMO2.4A_rerun', f'{freq_str}/templ1s{racmo24_enbudsep}*.nc'),
        'templ1spr': connect_paths('RACMO2.4A_rerun', f'{freq_str}/templ1spr{racmo24_enbudsep}*.nc'),
        'tendtot': connect_paths('RACMO2.4A_rerun', f'{freq_str}/tendtot{racmo24_enbudsep}*.nc'),
        'tendtotpr': connect_paths('RACMO2.4A_rerun', f'{freq_str}/tendtotpr{racmo24_enbudsep}*.nc'),
        'udtdx': connect_paths('RACMO2.4A_rerun', f'{freq_str}/udtdx{racmo24_enbudsep}*.nc'),
        'vdffric': connect_paths('RACMO2.4A_rerun', f'{freq_str}/vdffric{racmo24_enbudsep}*.nc'),
        'vdfphase': connect_paths('RACMO2.4A_rerun', f'{freq_str}/vdfphase{racmo24_enbudsep}*.nc'),
        'vdfsens': connect_paths('RACMO2.4A_rerun', f'{freq_str}/vdfsens{racmo24_enbudsep}*.nc'),
        'vdftot': connect_paths('RACMO2.4A_rerun', f'{freq_str}/vdftot{racmo24_enbudsep}*.nc'),
        'vdtdy': connect_paths('RACMO2.4A_rerun', f'{freq_str}/vdtdy{racmo24_enbudsep}*.nc'),
        'vertadv': connect_paths('RACMO2.4A_rerun', f'{freq_str}/vertadv{racmo24_enbudsep}*.nc'),
    }
