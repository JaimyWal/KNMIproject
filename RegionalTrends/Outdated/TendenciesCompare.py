...
# Boolean with tendtot from temp. E-obs is then also an option

# Tendtot: [dlkdjldk etc etc]
...
# Maybe some figures on aerosoles versus non aerosoles and plot this in a map or something
